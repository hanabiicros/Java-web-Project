		...
		<div class="container" style="width: 1000px;">
				...
				<div class="form-group">
					<div class="col-sm-8" style="text-align: center;">
						<span>订单编号：</span> <input type="number" placeholder="请输入纯数字~"
							name="id" value="${searchorders.id}" style="border: 1px solid;"/> <span>订单信息：</span> <input
							type="text" name="orderInformation" value="${searchorders.orderInformation}" style="border: 1px solid;"/> <span>状态：</span>
						<select name="orderState" id="myselected" style="border: 1px solid;">
			...
			<div style="text-align: right">
				<div class="pagination">
					<ul>
						<li><a>共:${ordersGrid.total }页</a></li>
						...
						<c:if test="${ordersGrid.current < ordersGrid.total }">
							<li><a
				...
				<div class="modal-body" style="height: 0 auto;">
					<form class="form-horizontal" id="myeditform" name="myform">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="orderId" style="margin-top: 8px;" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">所属用户:</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="userId" style="margin-top: 8px;" />
							</div>
						</div>
						<div class="form-group">
				...
				<div class="modal-body" style="height: 0 auto;">
					<form class="form-horizontal" id="myviewform" name="myform">
						...
						<div class="form-group">
							<label class="col-sm-4 control-label">所属用户:</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" name="userId" readonly style="margin-top: 8px;" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-4 control-label">订单价格:</label>
		...
		function doView(id){
			$.ajax({
				...
				success:function(json){
					if(json){
						$('#myviewform').find("input[name='orderId']").val(json.id);
			...
			$.ajax({
				...
				success:function(json){
					if(json){
						...
						$('#myeditform').find("input[name='orderId']").val(json.id);
