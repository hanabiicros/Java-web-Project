		...
		<div id="content-header">
			<div id="breadcrumb">
				<a href="<%=basePath%>admin/indexs" title="主页" class="tip-bottom"><i
					class="icon-home"></i>主页</a> <a title="充值列表" class="tip-bottom">钱包列表</a>
			</div>
		</div>
		<!--End-breadcrumbs-->
			...
			<form class="form-horizontal" id="myserchform" name="myform"
				...
				<div class="form-group">
					<div class="col-sm-5" style="text-align: center;">
						...
						<input type="number" placeholder="请输用户id" name="userId" value="${searchpurse.userId}" class="form-control" style="border: 1px solid;"/> 
					</div>
					<div class="col-sm-5" style="text-align: left;">
					<select name="state" data-style="btn-info" class="form-control" id="myselected" style="border: 1px solid;">
			...
			<div style="text-align: right">
				<div class="pagination">
					<ul>
						...
						<c:if test="${purseGrid.current < purseGrid.total }">
							<li><a
