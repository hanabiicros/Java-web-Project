			...
			<!--搜索栏-->
			 <form class="form-horizontal" id="myserchform" name="myform" action="<%=basePath%>admin/searchUser" method="post">
				...
				<div  class="col-sm-8" style="text-align:center;">
					<span >手机：</span>
					<input placeholder="请输入正确的手机号~" name="phone" value="${searchuser.phone}" style="border: 1px solid;"/>
					<span >昵称：</span>
					<input type="text" name="username" value="${searchuser.username}" style="border: 1px solid;"/>
					<span >QQ：</span>
					<input type="text" name="qq" value="${searchuser.qq}" style="border: 1px solid;"/>
				</div>
					<div class="col-sm-4">
			...
			<div style="text-align: right">
				<div class="pagination">
					<ul>
						...
						<c:if test="${userGrid.current < userGrid.total+9}">
							<li><a
