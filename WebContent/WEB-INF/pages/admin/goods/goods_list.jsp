			...
			<!--搜索栏-->
			 <form class="form-horizontal" id="myserchform" name="myform" action="<%=basePath%>admin/searchGoods" method="post">
				...
				<div  class="col-sm-8" style="text-align:center;">
					<span >商品ID：</span>
					<input type="number" placeholder="请输入纯数字~" name="id" value="${searchgoods.id}" style="border: 1px solid;"/>
					<span >名称：</span>
					<input type="text"  name="name" value="${searchgoods.name}" style="border: 1px solid;"/>
					<span >状态：</span>
					<select name="status" id="myselected" style="border: 1px solid;">
			...
			<div style="text-align: right">
				<div class="pagination">
					<ul>
						...
						<c:if test="${goodsGrid.current < goodsGrid.total }">
							<li><a
