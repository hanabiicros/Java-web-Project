                        ...
                        <c:forEach var="items" items="${goodsAndImage}">
                            <div class="story">
                                ...
                                <div class="box">
                                    ...
                                    <c:if test="${items.goods.endTime > date}">
                                    <div class="interact">
                                    ...
                                    <c:if test="${items.goods.endTime < date}">
                                    	<div class="interact">
                                    		<span style="color: #939cac;">抱歉，您发布的该商品已过期，请<a href="<%=basePath%>goods/deleteGoods/${items.goods.id}" style="color: #F6492F;">删除</a>后重新发布</span>
                                    	</div>
                                    	<br>
                                    </c:if>
                                    <!-- 
