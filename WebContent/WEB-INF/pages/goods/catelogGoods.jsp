              ...
              <a href="<%=basePath%>user/home?pageNum=1">
				 ...
				 <div class="userImg">
				 	<c:if test="${empty cur_user.imgUrl}">
	                    <img id="pic" src="<%=basePath%>img/3.jpg" style="width: 100%;">
	                </c:if>
	                <c:if test="${!empty cur_user.imgUrl}">
	                    <img id="pic" src="<%=basePath%>upload/${cur_user.imgUrl}" style="width: 100%;">
	                </c:if>
				</div>
				 </li>
				</a>
            ...
            <div class="row">
                   ...
                   <a onclick="showSignup()">
                    ...
                    <div class="input-field col s12 phone1">
                        <input id="registerPhone" type="text" name="phone" id="phone" required="required" pattern="^1[0-9]{10}$" class="validate ng-pristine ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-touched" />
